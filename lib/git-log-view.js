    ...
    this.on('core:move-up', (function(self) {
        return function(e) {
            if((self.previous_line == null) || (self.previous_line == 1))
                return;
            self.select_display_info(null, self.previous_line-1);
            console.log('move-up')
            //self.select_display_info(null, line);
        };
    })(this));
...
GitLogView.prototype.select_display_info = function(event, line) {
