...
function GitGraph(location, data, line_height) {
    ...
    var width = this.config.left_margin + this.max_column * this.config.branch_spacing;
...
GitGraph.prototype.render = function(location, data) {
    ...
    var width = this.config.left_margin * 2 + this.max_column * this.config.branch_spacing;
